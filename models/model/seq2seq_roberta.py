...
class Module(Base):
    ...
    def __init__(self, args, vocab):
        ...
        self.dec = decoder(self.emb_action_low, args.dframe, 768,
                           pframe=args.pframe,
    ...
    def featurize(self, batch, load_mask=True, load_frames=True):
        ...
        for ex in batch:
            ...
            instr_str = ''.join(ex['turk_annotations']['anns'][r_idx]['high_descs']) + ' <<stop>>'
            goal_instr_str = goal_str + instr_str
            goal_instr.append(goal_instr_str)
        ...
        feat['lang_goal_instr'] = self.tokenizer(goal_instr, return_tensors='pt', padding=True)
        feat['lang_goal_instr'] = feat['lang_goal_instr'].to(device)
        return feat
    ...
    def encode_lang(self, feat):
        ...
        return cont_roberta_output, roberta_output_last_layer_vec
